...
def create_indexes_for_chat_messages_collection():
    """Create indexes for all payload fields in the chat messages collection"""
    ...
    print("\n✅ Finished adding indexes for chat messages collection!")
